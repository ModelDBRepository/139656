...
Simoes de Souza FM and De Schutter E (2011) Robustness effect of gap junctions between Golgi cells on cerebellar cortex oscillations. *Neural Systems & Circuits* 1:7.
...
Change directory to the network folder. Run `nrnivmodl`. Then type `nrngui mosinit.hoc`

----

Uncomment the GJ flag on `mosinit.hoc` to select a network with or without GJ between GoCs. Once the simulation is started it will produce a result similar to figure 9 from Simoes de Souza and De Schutter 2011.
